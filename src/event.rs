...
fn handle_keys_display_stock(keycode: KeyCode, modifiers: KeyModifiers, mut app: &mut app::App) {
    match (keycode, modifiers) {
        ...
        (KeyCode::BackTab, KeyModifiers::SHIFT) | (KeyCode::F(1), KeyModifiers::NONE) => {
        ...
        (KeyCode::Char('k'), KeyModifiers::NONE) | (KeyCode::Delete, KeyModifiers::NONE) | (KeyCode::Char('d'), KeyModifiers::NONE) => {
        ...
        (KeyCode::Tab, KeyModifiers::NONE) | (KeyCode::F(2), KeyModifiers::NONE) => {
